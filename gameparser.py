...
def normalise_input(user_input):
    ...
    #output = []
    normalise = remove_punct(user_input).lower()
    normalise1 = normalise.split(" ")
    normalise2 = filter_words(normalise1,skip_words)
    #normalise2 = normalise.strip(" ")
    #output.append(normalise)
    return normalise2
    ...
    #normalise2 = user_input.strip(normalise)
    #normalise3 = filter_words()
    #text_normalise = normalise.lower()
    #text_normalise.split()
